...
const messages: Message[] = [
  {
    ...
    time: "10:42 AM",
    content:
      "Welcome to the refinery, Oga! Abeg, see this one! I don filter the latest high-paying gigs for you today.",
  },
  {
    id: 2,
    sender: "user",
    ...
    <div className="flex-1  p-8 space-y-8 hide-scrollbar">
      {messages.map((msg) => (
        ...
        >
          ...
          <div
            className={`space-y-3 max-w-2xl ${msg.sender === "user" ? "text-right" : ""}`}
          >
