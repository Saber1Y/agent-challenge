...
export function RateCard({ exchange, rate, change, isBest = false, logo }: RateCardProps) {
  ...
  return (
    <div
      className={`bg-surface-container-low p-4 rounded-xl shadow-lg transition-all ${
    ...
    >
      ...
      <p className="text-2xl font-black font-headline text-white">₦{rate.toLocaleString()}</p>
      <div
