...
const navItems = [
  ...
  { name: 'Market Rates', icon: 'trending_up', href: '#' },
  { name: 'Wallet', icon: 'account_balance_wallet', href: '#' },
  { name: 'Hustle Chat', icon: 'forum', href: '#', active: true },
]
  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 border-r border-slate-800/50 bg-slate-900/70 backdrop-blur-xl flex flex-col py-8 px-4 z-50">
      <div className="mb-10 px-2">
        ...
        <p className="text-xs text-slate-400 font-label tracking-widest mt-1">
          DIGITAL ALCHEMIST
        </p>
      </div>
      ...
      <div className="mt-auto space-y-2">
        <button className="w-full bg-indigo-500 text-white font-bold py-3 rounded-lg mb-6 hover:opacity-90 active:scale-95 transition-all font-headline">
          Post Bounty
        </button>
        <a
          href="#"
